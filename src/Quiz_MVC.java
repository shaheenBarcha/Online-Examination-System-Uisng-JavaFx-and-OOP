...
public class Quiz_MVC extends Std_Home
{
	Stage stage;
	Scene scene;
	int marks = 0;
	...
	private void addcomp()
	{
		...
		Label header = new Label("MVC Exam (Total 10 Marks)");
		header.setFont(Font.font("Arial",FontWeight.BOLD,20));
		
		Filing cnn = new Filing();
		
		cnn.read_questions(Teach_MVC.getMVCQ());	
		cnn.read_options(Teach_MVC.getMVCO());
