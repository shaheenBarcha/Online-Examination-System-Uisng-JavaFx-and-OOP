...
public class Teacher_reg extends Home
{
	private String username = "";
	private String password = "";
	static String Teacher = "data_teach.txt";
	static String User_PassTeach = "User_PassTeach.txt";
	String details = "";
	...
	private void addcomp()
	{
		...
		Label l5 = new Label("Course Timings");
		...
		btnregister.setOnAction(new EventHandler<ActionEvent>()
		{
			...
			public void handle(ActionEvent event)
			{
				...
				try
				{
					file.WriteToDataFile(details,Teacher);
					file.WriteToUser_Pass(username,User_PassTeach);
					file.WriteToUser_Pass(password,User_PassTeach);
				}
				catch (IOException e) 
				{
					e.printStackTrace();
