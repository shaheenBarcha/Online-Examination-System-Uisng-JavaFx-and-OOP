...
public class Teach_OOP extends Teach_Home
{
	Stage stage;
	Scene scene;
	
	private static String OOPQ = "OOPQ.txt";
	private static String OOPO = "OOPO.txt";
	...
	public void start(Stage s) throws Exception 
	{
		...
		stage.setHeight(720);
		stage.setWidth(800);
		stage.setTitle("Object Oriented Programming Exams");
		addcomp();
	...
	private void addcomp()
	{
		...
		btnsubmit.setOnAction(new EventHandler<ActionEvent>() {
			...
			{	
				...
				try
				{
					cnn.WriteToQuest(questions,getOOPQ());
				}
				catch (IOException e)
				{
					e.printStackTrace();
				...
				try
				{
					cnn.WriteToOpt(options,getOOPO());
				}
				catch (IOException e)
				{
					e.printStackTrace();
	...
	public static String getOOPO() {
		return OOPO;
	}

	public static void setOOPO(String oOPO) {
		OOPO = oOPO;
	}

	public static String getOOPQ() {
		return OOPQ;
	}

	public static void setOOPQ(String oOPQ) {
		OOPQ = oOPQ;
	}
}
