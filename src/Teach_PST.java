...
public class Teach_PST extends Teach_Home
{
	Stage stage;
	Scene scene;
	
	private static String PSTQ = "PSTQ.txt";
	private static String PSTO = "PSTO.txt";
	private static String PSTA = "PSTA.txt";
	...
	private void addcomp()
	{
		...
		Label header = new Label("Pakistan Studies Exam (Total 10 Marks)");
		...
		btnsubmit.setOnAction(new EventHandler<ActionEvent>() {
			...
			{	
				...
				try
				{
					cnn.WriteToQuest(questions,getPSTQ());
				}
				catch (IOException e)
				{
					e.printStackTrace();
				...
				try
				{
					cnn.WriteToOpt(options,getPSTO());
				}
				catch (IOException e)
				{
					e.printStackTrace();
	...
	public static String getPSTO() {
		return PSTO;
	}

	public static void setPSTO(String pSTO) {
		PSTO = pSTO;
	}

	public static String getPSTQ() {
		return PSTQ;
	}

	public static void setPSTQ(String pSTQ) {
		PSTQ = pSTQ;
	}
}
